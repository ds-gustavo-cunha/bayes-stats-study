...
cli_parser.add_argument('--treatment_likelihood_prob', type=float, default=0.75, nargs='?')
cli_parser.add_argument('--treatment_likelihood_trials', type=int, default=10, nargs='?')
